...
import type { Contract, CreateContract, UpdateContract, CreateContractVersion, User } from '../types';
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                {...register('landlordId', { required: 'Landlord is required' })}
                            ...
                            {errors.landlordId && (
                                <p className="text-red-600 text-sm mt-1">{errors.landlordId.message}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.rentIncreasePercentage && (
                                <p className="text-red-600 text-sm mt-1">{errors.rentIncreasePercentage.message}</p>
                            )}
                        </div>

...
export default function Layout({ children }: LayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-zinc-900">
            <div className="flex">
                {/* Sidebar */}
                <div className="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-zinc-800 shadow-lg">
                                ...
                                return (
                                    <Link
                                        ...
                                        className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive
                                            ? 'bg-blue-50 dark:bg-zinc-900 border-blue-500 text-blue-700 dark:text-blue-300'
                ...
                <div className="ml-64 flex-1">
                    <main className="px-8 py-6 bg-gray-50 dark:bg-zinc-900 min-h-screen">{children}</main>
                </div>
            </div>
        </div>
    );
